...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const GestiornarProductoAdministrador(),
    );
  }
}

class GestiornarProductoAdministrador extends StatefulWidget {
  const GestiornarProductoAdministrador({Key? key}) : super(key: key);

  @override
  _GestiornarProductoAdministradorState createState() =>
      _GestiornarProductoAdministradorState();
}

class _GestiornarProductoAdministradorState
    extends State<GestiornarProductoAdministrador> {
